"""
Django settings for BankReconciliation project.
...
SECRET_KEY = '1=b0^jmnook-pxp$^+4s8tgpffg-l5*vqas+_(m8-#2squv4r#'
...
ROOT_URLCONF = 'BankReconciliation.urls'
...
WSGI_APPLICATION = 'BankReconciliation.wsgi.application'
