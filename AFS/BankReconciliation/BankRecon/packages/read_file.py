...
def convert_format(date_string):
    try:
        ...
        elif re.search("/", date_input) and re.search("citi", date_key_word_var.lower()) and re.search("bank", date_key_word_var.lower()):
            year_hiffen_time = date_input.split("/")[2]
            month_hiffen_time = date_input.split("/")[0]
            day_hiffen_tme = date_input.split("/")[1]
