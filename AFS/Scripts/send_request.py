...
logging.basicConfig(filename="D:/AdventsProduct/V1.1.0/AFS/ConsolFiles/logs/logs.log", format="%(asctime)s %(message)s", datefmt="%d-%m-%Y %I:%M:%S %p", level=logging.DEBUG)
