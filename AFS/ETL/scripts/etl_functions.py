...
class JobExecutionId:
    ...
    def __init__(self, m_processing_layer_id, m_processing_sub_layer_id, processing_layer_id, source_1_file_id, source_2_file_id, source_3_file_id, source_4_file_id, execution_id_properties):
        ...
        self._source_4_file_id = source_4_file_id
    ...
    def create_job_execution_id(self):
        try:
            file_ids = []
            if len(str(self._source_1_file_id)) > 0 and len(str(self._source_2_file_id)) > 0 and len(str(self._source_3_file_id)) > 0 and len(str(self._source_4_file_id)) > 0:
                file_ids = [self._source_1_file_id, self._source_2_file_id, self._source_3_file_id, self._source_4_file_id]
            elif len(str(self._source_1_file_id)) > 0 and len(str(self._source_2_file_id)) > 0 and len(str(self._source_3_file_id)) > 0:
