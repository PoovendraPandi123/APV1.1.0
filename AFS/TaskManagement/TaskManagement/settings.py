...
BASE_LOG_FOLDER = "G:/AdventsProduct/V1.1.0/AFS/TaskManagement/logs"

DB_CONFIG_FILE = os.path.join(BASE_DIR,"TaskManagement","config","db.json")
LOG_CONFIG_FILE = os.path.join(BASE_DIR, "TaskManagement", "config", "logging.json")
...
SECRET_KEY = '1-idj!!d+=$efc5*hl-6azvv)@%v%m)g2alcn*eb&=ue%fz8(i'
