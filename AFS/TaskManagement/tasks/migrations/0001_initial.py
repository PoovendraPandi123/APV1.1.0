# Generated by Django 3.1.7 on 2021-12-29 11:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_by', models.PositiveSmallIntegerField(null=True, verbose_name='User Id')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='Modified Date')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.jobs', verbose_name='Jobs (JobId - Auto Field)')),
            ],
            options={
                'db_table': 'tasks',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.jobs', verbose_name='Jobs (JobId - Auto Field)')),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.tasks', verbose_name='Tasks (TaskId - Auto Field)')),
            ],
            options={
