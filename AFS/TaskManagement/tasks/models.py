...
class Tasks(models.Model):
    ...
    job = models.ForeignKey(Jobs, verbose_name="Jobs (JobId - Auto Field)", on_delete=models.CASCADE)
...
#     action = models.AutoField(Tasks, verbose_name="Tasks (TaskId - Auto Field)", on_delete=models.CASCADE)
...
class ExecutionSequence(models.Model):
    ...
    job = models.ForeignKey(Jobs, verbose_name="Jobs (JobId - Auto Field)", on_delete=models.CASCADE)
    task = models.ForeignKey(Tasks, verbose_name="Tasks (TaskId - Auto Field)", on_delete=models.CASCADE)
