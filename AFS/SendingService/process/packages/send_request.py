...
logging.basicConfig(filename="G:/AdventsProduct/V1.1.0/AFS/SendingService/logs/etl.log", format="%(asctime)s %(message)s", datefmt="%d-%m-%Y %I:%M:%S %p", level=logging.DEBUG)
