# Generated by Django 3.2.2 on 2021-05-27 16:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('source', '0015_remove_mastertransformations_m_sources'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator_key', models.CharField(max_length=64, null=True, verbose_name='Operator Key')),
                ('operator_value', models.JSONField(null=True, verbose_name='Operator Value')),
